...
class Settings:
    ...
    POSTGRES_PORT: Union[str, int] = int(os.environ.get("HANS_MI_PSQL_PORT", 5432))
    SECRET_KEY: str = os.environ.get("HANS_MI_SECRET_KEY", "django-insecure-ys038snwqt5(l_7m%p6hh8ke20+w!8fbi+@covbk)^xl1@8r%-")
    APP_NAME: str = os.environ.get("APP_NAME", "management_interface")
    DEBUG: Union[str, bool] = os.environ.get("HANS_MI_DEBUG", True)
